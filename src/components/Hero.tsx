    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container relative z-10 px-4 pt-20 pb-16 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-navy-light/50 border border-brand-cyan/30 backdrop-blur-sm mb-8">
              <span className="w-2 h-2 rounded-full bg-brand-orange animate-pulse" />
              <span className="text-sm font-medium text-brand-cyan tracking-wide uppercase">Your Next Adventure Awaits</span>
            </div>

            <h1 className="text-5xl md:text-7xl font-bold font-heading mb-6 tracking-tight leading-[1.1]">
              Experience Hurghada <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-orange via-yellow-400 to-brand-orange bg-[size:200%] animate-gradient">
                Like Never Before
              </span>
            </h1>
            
            <p className="text-lg md:text-xl text-gray-300 mb-10 max-w-2xl font-sans leading-relaxed">
              Dive into crystal clear waters, conquer the desert dunes, and ride into the sunset. The ultimate Red Sea experience curated just for you.
            </p>
